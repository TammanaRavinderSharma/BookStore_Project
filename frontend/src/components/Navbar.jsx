      ...
      <nav className='flex justify-between items-center'>
        <div className='flex items-center md:gap-16 gap-4'>
          ...
          <div className='relative sm:w-72 w-40 space-x-2'>
            <FiSearch className='absolute inline-block left-3  inset-y-2 top-1.5 '/>
          ...
          <div>
            {
              ...
              <img src={avatarImg} alt="avatar" className={`size-7 rounded-full 
              ...
              </> : <Link to="/login"><FaUserCircle className='size-8 text-blue-400 ' /></Link>
            }
           ...
           <Link to="/cart" className='bg-blue-400  p-1 sm:px-6 px-2 flex items-center rounded-sm '>
