...
const Register = () => {
  ...
  <div className='h-[calc(100vh-120px)] flex justify-center items-center '>
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div >
            <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-xl focus:outline-black  '>Register</button>
        </div>
    </form>
    <p className='text-white align-baseline mt-4 text-sm'>Have an account ? <Link to="/Login" className='text-blue-500 hover:text-blue-600'>Login</Link></p>
       <div>
        <button 
