    ...
    <footer className="bg-gray-900 text-white py-10 px-4">
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <ul className="flex flex-col md:flex-row gap-4">
            <li><a href="#home" className="hover:text-red-300">Home</a></li>
        ...
        <div className="md:w-1/2 w-full">
          ...
          <div className="flex">
            <input
              ...
              className="w-full px-4 py-2 rounded-l-md text-white bg-slate-700/80" 
            />
            <button className="bg-white text-black px-6 py-2 rounded-r-md hover:bg-redtext-red-300-dark">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center mt-10 border-t border-gray-700 pt-6">
        ...
        <ul className="flex gap-6 mb-4 md:mb-0">
          <li><a href="#privacy" className="hover:text-red-300">Privacy Policy</a></li>
          <li><a href="#terms" className="hover:text-red-300">Terms of Service</a></li>
        </ul>
